   ...
   public class TestVideokartyaController
   {
       public void FillTestDatabase(TestProjektContext ctx)
       {
           ctx.Videokartyak.Add(
            ...
            ctx.Videokartyak.Add(
              new Videokartya { Id = 1, Nev = "Demo2", AlaplapiCsatlakozas = "Pci2", AjanlottTapegyseg = 400, MonitorCsatlakozas = "Valami,Valami2", ChipGyartoja = "MAS", Vram = 9 });
            ctx.Videokartyak.Add(
              new Videokartya { Id = 1, Nev = "Demo3", AlaplapiCsatlakozas = "Pci3", AjanlottTapegyseg = 550, MonitorCsatlakozas = "Valami,Valami2", ChipGyartoja = "NVIIDA", Vram = 5 });
